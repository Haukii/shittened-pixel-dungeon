...
public class CursedEyeSprite extends MobSprite {
	...
	public CursedEyeSprite() {
		...
		charging.frames( frames, 19, 20 );
		
		run = new Animation( 12, true );
		run.frames( frames, 21, 22 );
		
		attack = new Animation( 8, false );
		attack.frames( frames, 20, 19 );
		zap = attack.clone();
		
		die = new Animation( 8, false );
		die.frames( frames, 23, 24, 25 );
