...
public class DM105Sprite extends MobSprite {
	...
	public DM105Sprite() {
		...
		run.frames( frames, 54, 55, 56, 57 );
		
		attack = new Animation( 12, false );
		attack.frames( frames, 50, 51, 52, 48 );

		zap = new Animation( 8, false );
		zap.frames( frames, 53, 53, 49 );

		die = new Animation( 12, false );
		die.frames( frames, 58, 59, 60, 61, 62, 63 );
