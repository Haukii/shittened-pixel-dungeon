...
public class DM102a2Sprite extends MobSprite {

	public DM102a2Sprite() {
		super();
		...
		idle.frames( frames, 64, 65 );

		run = new Animation( 12, true );
		run.frames( frames, 70, 71, 72, 73 );
		
		attack = new Animation( 12, false );
		attack.frames( frames, 66, 67, 68, 64 );

		zap = new Animation( 8, false );
		zap.frames( frames, 69, 69, 65 );

		die = new Animation( 12, false );
		die.frames( frames, 74, 75, 76, 77, 78, 79 );
