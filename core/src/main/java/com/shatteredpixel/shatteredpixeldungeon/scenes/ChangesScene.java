...
import com.shatteredpixel.shatteredpixeldungeon.ui.changelist.v1_0_Changes;
...
public class ChangesScene extends PixelScene {
	...
	public void create() {
		...
		switch (changesSelected){
			case 0: default:
				v1_0_Changes.addAllChanges(changeInfos);
				break;
		}
		...
		StyledButton btn2_X = new StyledButton(Chrome.Type.GREY_BUTTON_TR, "1.0"){
			@Override
