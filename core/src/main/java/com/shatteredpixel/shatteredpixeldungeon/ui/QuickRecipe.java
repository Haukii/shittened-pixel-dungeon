...
import com.shatteredpixel.shatteredpixeldungeon.items.misc.StoneAmulet;
	...
	public static ArrayList<QuickRecipe> getRecipes( int pageIdx ){
		...
		switch (pageIdx){
			...
			case 2:
				...
				result.add(null);
				result.add(new QuickRecipe(new StewedSmallMeat.oneMeat()));
				result.add(new QuickRecipe(new StewedSmallMeat.twoMeat()));
				result.add(new QuickRecipe(new StewedSmallMeat.threeMeat()));
				result.add(new QuickRecipe( new FrozenCarpaccio.frozenMeat() ));
				result.add(new QuickRecipe( new StewedMeat.fromSmallMeat() ));
				result.add(new QuickRecipe( new GoldenMeat.Craft() ));
				...
				result.add(new QuickRecipe(new Coffee.Recipe()));
				result.add(new QuickRecipe(new TripleShotEspresso.Recipe()));
				result.add(new QuickRecipe(new FriedEgg.Recipe()));
				result.add(new QuickRecipe(new Omelet.Recipe()));
				result.add(new QuickRecipe(new Pancakes.Recipe()));
				result.add(new QuickRecipe(new PancakesWithCheese.Recipe()));
				result.add(new QuickRecipe(new Bread.Recipe()));
				result.add(new QuickRecipe(new Hashbrowns.Recipe()));
				result.add(new QuickRecipe(new CompleteBreakfast.Recipe()));
				result.add(new QuickRecipe(new Bruschetta.Recipe()));
				result.add(new QuickRecipe(new Pizza.Recipe()));
				result.add(new QuickRecipe(new Spaghetti.Recipe()));
				result.add(new QuickRecipe(new StirFry.Recipe()));
				result.add(new QuickRecipe(new BakedFish.Recipe()));
				result.add(new QuickRecipe(new CrispyBass.Recipe()));
				result.add(new QuickRecipe(new BerryBalls.Recipe()));
				result.add(new QuickRecipe(new Sashimi.Recipe()));
				result.add(new QuickRecipe(new Meatballs.Recipe()));
				result.add(new QuickRecipe(new Cookies.Recipe()));
				result.add(new QuickRecipe(new IceCream.Recipe()));
				result.add(new QuickRecipe(new DanishPastry.Recipe()));
				result.add(new QuickRecipe(new CakeBase.Recipe()));
				result.add(new QuickRecipe(new BerryCake.Recipe()));
				result.add(new QuickRecipe(new ChocolateCake.Recipe()));
			...
			case 8:
				...
				return result;
			case 9:
				result.add(new QuickRecipe(new GoldBar.Craft()));
				result.add(new QuickRecipe(new GoldAmulet.Craft()));
				result.add(new QuickRecipe(new PinkAmulet.Craft()));
